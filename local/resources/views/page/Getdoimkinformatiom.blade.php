...
<!-- Main Container Starts -->
	...
	<!-- Breadcrumb Starts -->
		<ol class="breadcrumb">
			...
			<li class="active"><a href="{{route('information')}}">Thông tin</a></li>
		...
		<section class="registration-area">
			<div class="row">
				...
				<!-- Registration Block Starts -->
					<div class="panel panel-smart">
						...
						<!-- Registration Form Starts -->
							<form class="form-horizontal"  method="post" action="{{route('doimkinformatiom')}}" role="form" enctype="multipart/form-data">
								<input type="hidden" name="_token" value="{{csrf_token()}}">
							<!-- Personal Information Starts -->
								<div class="form-group">
									<label for="inputFname" class="col-sm-3 control-label">Mật khẩu cũ :</label>
									<div class="col-sm-9">
				...
				<!-- Registration Block Ends -->
						<a href="{{route('information')}}"><button type="button" class="btn btn-secondary" >Quay lại</button></a>
