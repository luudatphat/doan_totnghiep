...
-- Thời gian đã tạo: Th6 22, 2019 lúc 04:32 PM
...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  `remember_token` varchar(100) COLLATE utf32_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `admin` (`id`, `username`, `password`, `updated_at`, `created_at`, `remember_token`) VALUES
(1, 'admin', '$2y$10$FFlabqeIQYLK8HgluxU23OFC1I2jil9CC1m41jZe9Tn3QEe3E.6y2', NULL, NULL, 'xBKYEdaHGQRofdekXMxDJTEHV0eKQuX8u2gYv112aG8JgMg07fieSu7VS4BE');
...
CREATE TABLE IF NOT EXISTS `chitiethoadon` (
  ...
  `masanpham` varchar(100) CHARACTER SET utf32 COLLATE utf32_unicode_ci DEFAULT NULL,
...
INSERT INTO `chitiethoadon` (`idhoadon`, `idsanpham`, `masanpham`, `tensanpham`, `avatar`, `soluong`, `gia`, `created_at`, `updated_at`) VALUES
(231, 25, 'Nokia31', 'Điện thoại Nokia 3.1 ', 'nokia-31-plus1.jpg', 1, 2000000, '2019-06-21 04:56:17', '2019-06-21 04:56:17'),
(232, 26, '61Plus', 'Điện thoại Nokia 6.1 Plus ', 'nokia-61-plus-3-400x460.png', 1, 5000000, '2019-06-21 04:57:04', '2019-06-21 04:57:04'),
(234, 30, 'nokia8110', 'Điện thoại Nokia 8110 4G ', 'nokia-8110-4g-gold-400x460.png', 1, 900000, '2019-06-21 04:57:47', '2019-06-21 04:57:47'),
(235, 29, 'nokia230', 'Điện thoại Nokia 230 ', 'nokia-230-khong-the-blue-400x460.png', 1, 1000000, '2019-06-21 04:57:58', '2019-06-21 04:57:58'),
(237, 26, '61Plus', 'Điện thoại Nokia 6.1 Plus ', 'nokia-61-plus-3-400x460.png', 1, 5000000, '2019-06-21 05:27:01', '2019-06-21 05:27:01'),
(238, 25, 'Nokia31', 'Điện thoại Nokia 3.1 ', 'nokia-31-plus1.jpg', 1, 2000000, '2019-06-21 05:55:53', '2019-06-21 05:55:53'),
(238, 26, '61Plus', 'Điện thoại Nokia 6.1 Plus ', 'nokia-61-plus-3-400x460.png', 1, 5000000, '2019-06-21 05:55:53', '2019-06-21 05:55:53'),
(239, 25, 'Nokia31', 'Điện thoại Nokia 3.1 ', 'nokia-31-plus1.jpg', 1, 2000000, '2019-06-21 05:55:55', '2019-06-21 05:55:55'),
(239, 26, '61Plus', 'Điện thoại Nokia 6.1 Plus ', 'nokia-61-plus-3-400x460.png', 1, 5000000, '2019-06-21 05:55:56', '2019-06-21 05:55:56'),
(240, 25, 'Nokia31', 'Điện thoại Nokia 3.1 ', 'nokia-31-plus1.jpg', 1, 2000000, '2019-06-21 10:07:20', '2019-06-21 10:07:20'),
(242, 118, '118_admin123', 'admin123', '5_5.jpg', 10, 123, '2019-06-21 15:04:31', '2019-06-21 15:04:31'),
(243, 117, '117_admin', 'admin', '3_1.jpg', 20, 123, '2019-06-21 15:05:17', '2019-06-21 15:05:17');
...
(326, '3_5.jpg', 116),
(327, '3_Capture.PNG', 116),
(328, '3_Capture1.PNG', 116),
(329, '3_1.jpg', 117),
(330, '5_5.jpg', 118);
...
CREATE TABLE IF NOT EXISTS `hoadon` (
  ...
  `tennguoidung` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `idnguoiban` int(10) DEFAULT NULL,
  `trangthai` int(50) DEFAULT NULL,
  `xuly` int(10) DEFAULT NULL,
  `tennguoidat` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `dienthoai` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `email` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `diachi` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `tongtienchuathue` int(100) DEFAULT NULL,
  `thue` int(100) DEFAULT NULL,
...
INSERT INTO `hoadon` (`id`, `ma`, `idnguoidung`, `tennguoidung`, `idnguoiban`, `trangthai`, `xuly`, `tennguoidat`, `dienthoai`, `email`, `diachi`, `tongtienchuathue`, `thue`, `tongtien`, `created_at`, `updated_at`) VALUES
(231, '496673209', 3, 'admin', 3, 2, 1, 'admin', '0707477686', 'thongoc_dangyeu1982@yahoo.com', '2/aĐường 29Quận 1Hồ chí minh', 2000000, 420000, 2420000, '2019-06-21 04:56:16', '2019-06-21 14:01:58'),
(232, '298652061', 3, 'admin', 3, 2, 1, 'admin', '0707477686', 'thongoc_dangyeu1982@yahoo.com', '30Đường 29Quận 1Hồ chí minh', 5000000, 1050000, 6050000, '2019-06-21 04:57:04', '2019-06-21 14:12:51'),
(234, '2060264138', 3, 'admin', 3, 2, 1, 'admin', '0707477686', 'thongoc_dangyeu1982@yahoo.com', '30Đường 29Quận 1Hồ chí minh', 900000, 189000, 1089000, '2019-06-21 04:57:47', '2019-06-21 14:44:36'),
(235, '821886592', 3, 'admin', 3, 2, 1, 'admin', '0707477686', 'thongoc_dangyeu1982@yahoo.com', '30Đường 29Quận 1Hồ chí minh', 1000000, 210000, 1210000, '2019-06-21 04:57:58', '2019-06-22 03:23:08'),
(237, '38809207', 3, 'admin', 3, 0, 0, 'admin', '0707477686', 'thongoc_dangyeu1982@yahoo.com', '30Đường 29Quận 1Hồ chí minh', 5000000, 1050000, 6050000, '2019-06-21 05:27:01', '2019-06-21 05:50:15'),
(238, '999662650', 3, 'admin', 3, 0, 0, 'admin', '0707477686', 'thongoc_dangyeu1982@yahoo.com', '30Đường 29Quận 1Hồ chí minh', 7000000, 1470000, 8470000, '2019-06-21 05:55:53', '2019-06-21 05:55:53'),
(239, '1764293512', 3, 'admin', 3, 0, 0, 'admin', '0707477686', 'thongoc_dangyeu1982@yahoo.com', '30Đường 29Quận 1Hồ chí minh', 7000000, 1470000, 8470000, '2019-06-21 05:55:55', '2019-06-21 05:55:55'),
(240, '148193919', 4, 'datphat', 3, 0, 0, 'datphat', '0707474696', 'luudatphat@gmail.com', '30Đường 29Quận 1Hồ chí minh', 2000000, 420000, 2420000, '2019-06-21 10:07:20', '2019-06-21 10:07:20'),
(242, '158355664', 3, 'admin', 5, 0, NULL, 'admin', '0707477686', 'thongoc_dangyeu1982@yahoo.com', '30Đường 29Quận 1Hồ chí minh', 1230, 258, 1488, '2019-06-21 15:04:31', '2019-06-21 15:04:31'),
(243, '1851039731', 5, 'admiin123', 3, 0, NULL, 'admiin123', '0707474696', 'oanh@gmail.com', '30Đường 29Quận 1Hồ chí minh', 2460, 517, 2977, '2019-06-21 15:05:17', '2019-06-21 15:05:17');
...
(3, 'admin', '$2y$10$3zUQP6BCidMbEsa5XGc/kOo7LwMTvbpt2L30et/kG6gIAxN9M3LlW', 'admin', '0707477686', 'thongoc_dangyeu1982@yahoo.com', 'admin123', 'admin_msi-prestige-ps42-i5-8250u-4gb-256gb-14-win10-33397-thumb-123-600x600.jpg', NULL, NULL, 'H1uJNCU0Yv98hbtmmWtIUz8v2YBnd6tCJ2AqTqy4KByPo3ZC9LHfF2ru620Y'),
(4, 'datphat', '$2y$10$rldfuWlYyyV/yq.OEW1bhOk1puq1CrbFahXmIWTVmShI71BcxtlBu', 'datphat123', '0707474696', 'luudatphat@gmail.com', 'datphat', 'datphat_FullSizeRender_1_1.jpg', NULL, NULL, 'jgpfenDyV6TzspsDtqz313S3C9LYa4JIsf11U294STaiAOzhMitirxqzo3tx'),
(5, 'admin123', '$2y$10$4EvL2JBW3N2aK6mPI.7Y3eWAW6YT9N.DO6jlEyLJ7ELCIrgQd4A6y', 'admiin123', '0707474696', 'oanh@gmail.com', 'admin123450986979', 'admin123_msi-prestige-ps42-i5-8250u-4gb-256gb-14-win10-33397-thumb-123-600x600.jpg', NULL, NULL, '8kyOokNpMycS1rkBz0mCdXfgkRbKT6PAGKGrH2M432L6WjI5UU0iu8k6M2fo');
...
CREATE TABLE IF NOT EXISTS `sanpham` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `ma` char(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ten` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `avatar` char(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `gia` double NOT NULL,
...
INSERT INTO `sanpham` (`id`, `ma`, `ten`, `avatar`, `gia`, `mota`, `idnguoidung`, `idloai`, `idhang`, `xuly`, `updated_at`, `created_at`) VALUES
(2, '6splus', 'iphone 6splus 32gb', 'iphone-6s-plus-32gb-400x460.png', 8000000, '-Camera được cải tiến:Điện thoại iPhone 6s Plus 32 GB được nâng cấp độ phân giải camera sau lên 12 MP (thay vì 8 MP như trên iPhone 6 Plus), camera cho tốc độ lấy nét và chụp nhanh, thao tác chạm để chụp nhẹ nhàng. Chất lượng ảnh trong các điều kiện chụp khác nhau tốt.\r\n\r\n-Cảm ứng 3D Touch độc đáo:3D Touch là tính năng hoàn toàn mới trên iPhone 6s Plus 32 GB, cho phép người dùng xem trước được các tùy chọn nhanh dựa vào lực nhấn mạnh hay nhẹ mà không cần phải nhấp vào ứng dụng.', 5, 1, 1, NULL, NULL, NULL),
...
(114, '123', '123', NULL, 123, '123', 3, 1, 1, NULL, '2019-06-07 16:45:30', '2019-06-07 16:45:30'),
(115, '123', '123', NULL, 123, '123', 3, 1, 7, NULL, '2019-06-07 16:45:54', '2019-06-07 16:45:54'),
(116, '116_luu dat phat', 'luu dat phat', '3_1.jpg', 123, '123', 3, 3, 20, NULL, '2019-06-21 01:44:58', '2019-06-21 01:44:58'),
(117, '117_admin', 'admin', '3_1.jpg', 123, '123', 3, 3, 19, NULL, '2019-06-21 15:01:44', '2019-06-21 15:01:44'),
(118, '118_admin123', 'admin123', '5_5.jpg', 123, '123', 5, 3, 19, NULL, '2019-06-21 15:02:11', '2019-06-21 15:02:11');
...
INSERT INTO `tsmypham` (`id`, `idthongso`, `xuatxu`, `trongluong`) VALUES
(19, 164, 'Pháp', 50),
(20, 165, 'Pháp', 50),
(21, 166, 'Hàn Quốc', 50),
(22, 167, 'Hàn Quốc', 200),
...
ALTER TABLE `chitiethoadon`
  ...
  ADD CONSTRAINT `cthd_sanpham_id_fk_1` FOREIGN KEY (`idsanpham`) REFERENCES `sanpham` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `hinhanh`
  ADD CONSTRAINT `hinhanh_sanpham_id_fk_1` FOREIGN KEY (`idsanpham`) REFERENCES `sanpham` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `thongso`
  ...
  ADD CONSTRAINT `thongso_sanpham_fkid_2` FOREIGN KEY (`idsanpham`) REFERENCES `sanpham` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
